...
public class CustomerController {
	...
	public Customer postCustomer(@RequestBody Customer customer) {
		...
		Customer _customer = repository.save(new Customer(customer.getName(), customer.getAge(),customer.getLastName()));
		return _customer;
	}
	...
	public List<Customer> findByFirstName(@PathVariable("lastName") String lastName) {
