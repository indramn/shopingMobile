<template>
  <div id="app" class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarText">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item" v-if="isLogged()">
              <a class="nav-link" href="/pricing">Chat</a>
            </li>
            <li class="nav-item">
          ...
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              ...
              <li class="nav-item">
              <router-link to="/heart" class="nav-link">
                <i class="fa fa-heart mr-1">
                  <span class="ml-1">{{this.heartProducts.length}}</span>
                </i>
              </router-link>
            </li>
    ...
    <footer class="container-fluid footer text-left mt-3">
      <p class="mr-auto">
        Developed by:
        <strong>Indresh Mn</strong>
      </p>
      <div style="float:right">
        <a href="mailto:indra.mn06@gmail.com" style="margin-right:10px">
          <i class="fa fa-envelope-open" aria-hidden="true" style="font-size:20px"></i>
        </a>
        <a href="https://github.com/indramn" target="_blank" style="margin-right:10px">
          <i class="fa fa-github" aria-hidden="true" style="font-size:20px"></i>
        </a>
        <a href="https://www.linkedin.com/in/indresh_mn/" target="_blank" style="margin-right:10px">
...
export default {
  ...
  computed: mapState(["cartProducts", "loggedUser","heartProducts"]),
  methods: {
    /* Initially loading the cart products from local storage */

    ...mapMutations(["SET_CART_PRODUCTS", "ADD_LOGGED_USER","ADD_HEART_PRODUCT"]),
    ...
    getHeartProduct() {
      ...
      if (products) {
        this.ADD_HEART_PRODUCT(products);
      }
    },
