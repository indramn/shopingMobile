  ...
  created() {
    http
      ...
      .then(response => {
        ...
        this.similarProduct =this.product
        
        this.product=this.product[0]
        console.log('this.product',this.product.productRating)
        this.rating=Number(this.product.productRating)
