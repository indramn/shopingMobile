      ...
      <div class="card-body">
        ...
        <div class="d-flex justify-content-between align-items-center">
          ...
          <small class="text-muted footerIcons">
            <a href="javascript:;;" class="p-2" @click="addToHeart(item)">
...
export default {
  ...
  methods: {
    ...
    ...mapMutations(["ADD_CART_LOCAL","ADD_HEART_PRODUCT"]),
    ...
    addToHeart(product) {
      const data = _.find(this.$store.getters.heartProducts, product);
      if (data) {
        infoToaster("Already Added", "Product Already Added");
      } else {
        successToaster("Added Successfully", "Product Added Successfully");
        this.ADD_HEART_PRODUCT(product);
      }
    },
